 ...
 * @author 挺
 */
public class GetNextInfoServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user_no.equals("null") || user_no.equals("undefined")) {
            sql = "select * from o_notice where notice_id < " + first_id + " and notice_to_dep = 0 and notice_to_major = 0 order by notice_id desc limit 10";
            rs = helper.getRs(sql);
            try {
            ...
            if (flag.equals("public")) {
                ...
                sql = "SELECT a.notice_id as notice_id,a.notice_title as notice_title, "
                        ...
                        + "and b.user_no = '" + user_no + "' and a.notice_id < " + first_id + " order by notice_id desc limit 10";
                rs = helper.getRs(sql);
                try {
                    content = GetJson.getIndexInfoNotJson(rs);
                } catch (SQLException e) {
