 ...
 * @author joyang
 */
public class getNextNewsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String content = "";
        String sql = "SELECT * FROM o_article WHERE article_id < " + first_id + " AND article_dep = " + dep_id + " order by article_id desc limit 10"; 
        rs = helper.getRs(sql);
        try {
