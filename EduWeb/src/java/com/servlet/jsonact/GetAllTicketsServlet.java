...
public class GetAllTicketsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String content = "";
        String sql = "select act_id,act_ticket_id,act_ticket_no from c_act_ticket where act_ticket_flag = 1 and user_no = "+ user_no +" order by act_ticket_id desc limit 0,10";
